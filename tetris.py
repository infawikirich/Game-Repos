...
def runGame():
    ...
    while True:   # main game loop
        ...
        if (movingLeft or movingRight) and time.time() - lastMoveSidewaysTime > MOVESIDEWASFREQ:
...
def showTextScreen(text):
    ...
    # center of the screen untila key is pressed
...
def checkForQuit():
    for event in pygame.event.get(QUIT): # get all get QUIT events 
...
def calculateLevelAndFallFreq(score):
    ...
    # how many seconds pass until a falling falls one space
...
def removeCompleteLines(board):
    ...
    while y >= 0:
        if isCompleteLine(board, y):
            ...
            # This is so that if the line that was pulled dow is also
