    ...
    while True:    # main game loop
        ...
        for event in pygame.event.get():     # event handling
            if event.type == pygame.MOUSEBUTTONUP:
                ...
                # check if the user presses a key to slide a tile
...
def checkForQuit():
    for event in pygame.event.get(QUIT):    # get all tje quit events
...
def makeMove(board, move):
    # This function does not check if teh move valid
